...
const LastWord_2 = (str) => {
    ...
    let lastWord=spaceStr.slice(spaceStr.length - 1);
...
for (let i=0;i<spiltStr.length;i++){
  if (spiltStr[i] == 'I'){
    spiltStr.splice(spiltStr.indexOf('I'), 1 , 'We');
  }
   if (spiltStr[i] == 'am') {
    spiltStr.splice(spiltStr.indexOf('am'), 1 , 'are');
    }
  if (spiltStr[i] == 'was') {
    spiltStr.splice(spiltStr.indexOf('was'), 1 , 'were'); 
  }
}
  return spiltStr.join(' ');}
// -------------------------------------------------------------------------------------------------------
