...
const filterLinks = (str) => {
    let linkStartWith = str.indexOf('www');
    let linkEndwith;
    if (str.includes("com")){
        linkEndwith = str.indexOf('com');
    }
    else if (str.includes("net")){
        linkEndwith = str.indexOf('net');
     }
     else if (str.includes("org")){
        linkEndwith = str.indexOf('org');
     }
    return str.substring(linkStartWith,linkEndwith+3);}
// -------------------------------------------------------------------------------------------------------
